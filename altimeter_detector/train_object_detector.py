...
if len(sys.argv) != 2:
    ...
    # go to the folder where this pyfile is in, and do:
    # python train_object_detector.py ..\dlib-19.24\examples\clocks1
    # python train_object_detector.py D:\study\Q5\additional_thesis\data\tif2jpg
    exit()
...
# options.detection_window_size = 30000
